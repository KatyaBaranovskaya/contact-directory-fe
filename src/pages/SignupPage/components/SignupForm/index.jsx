...
function SignupForm({ name, surname, lastname, email, password, confirmPassword, isLoading, isSuccessfullySubmitted, onChange, onClick }) {
  return (
    <div className="signup-form">
      ...
      <TextInput placeholder="name" name="name" value={name} onChange={onChange} />
      <TextInput placeholder="surname" name="surname" value={surname} onChange={onChange} />
      <TextInput placeholder="lastname" name="lastname" value={lastname} onChange={onChange} />
      ...
      <TextInput placeholder="confirm password" name="confirmPassword" type="password" value={confirmPassword} onChange={onChange} />
